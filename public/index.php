...
.carousel-item img {
  ...
  object-fit: cover;
        ...
        <div class="header-top alert fade show">
            <p>20% Discount All New Customers <a href='register'>get register</a></p>
                        ...
                        ?>
                            <li class="banner-category-item">
                                ...
                                <?php } ?>
                                 <?php
                                // Fetch subcategories for this category
                                $sub_sql = "SELECT * FROM all_products WHERE s_id = '$sub_id'";
                                $sub_result = mysqli_query($conn, $sub_sql);
                        ...
                        <div class="product-card">
                            <div class="product-media">
                                ...
                                <div class="product-widget">
                                    <a class='fas fa-random' href='compare.php' title='Product Compare'></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-btn-25">
                            <a class='btn btn-inline' href='shop-4column.php'>
        ...
        <section class="section feature-part">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-btn-25">
                            <a class='btn btn-outline' href='shop-4column.php'>
                                <i class="fas fa-eye"></i>
                            ...
                            <div class="category-wrap">
                                <div class="category-media">
                                    ...
                                    <div class="category-overlay">
                                        <a href='shop-4column.php'><i class="fas fa-link"></i></a>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-btn-50">
                            <a class='btn btn-outline' href='all-category.php'>
                                <i class="fas fa-eye"></i>
        ...
        <section class="section brand-part">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-btn-50">
                            <a class='btn btn-outline' href='brand-list.php'>
                                <i class="fas fa-eye"></i>
        ...
        <section class="section blog-part">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="section-btn-25">
                            <a class='btn btn-outline' href='blog-grid.php'>
                                <i class="fas fa-eye"></i>
