                    ...
                    <div class="col-sm-6 col-xl-3">
                        <div class="footer-widget">
                            <a class="footer-logo" href="#">
                                <img src="images/demo-logo-2.png" alt="logo">
                            </a>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="footer-bottom">
                            <p class="footer-copytext">&copy;  All Copyrights Reserved by <a target="_blank" href="https://tvssolutions.in/">TVS SOLUTIONS</a></p>
                            <p class="footer-copytext">DEVELOPED BY <a target="_blank" href="https://tvssolutions.in/">TVS SOLUTIONS</a></p>
