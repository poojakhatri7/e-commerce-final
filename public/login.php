...
<head>
    ...
    <style>
        body {
            ...
            background-image: url('./images/shop5.avif');
            background-size: contain;     /* fits image inside container */
...
<!-- <a href='/beauty_parlour_management_system/user'> -->
    ...
    <div class="footer">
        <p style="text-decoration: none; color: #5a2d77; font-weight: bold;">&copy; 2025 E-commerce Online Store. All rights reserved. </p>
    </div>
